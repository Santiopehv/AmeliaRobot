...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/280d9eef0c5329dbbc51d.jpg), ɪᴍ Charizard ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ charizard  ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/Charizard7904_bot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="updates ❤️& url=https://t.me/PigasusUpdates", callback_data="help_back"),
    ],
]


HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` Charizard [🙋‍♀️](https://telegra.ph/file/329647a798cccb101aecf.jpg)
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

Charizard_IMG = "https://telegra.ph/file/280d9eef0c5329dbbc51d.jpg"
...
def amelia_about_callback(update, context):
    ...
    if query.data == "amelia_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Charizard*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_bot licensed under the GNU General Public License v3.0
                 \n\nIf you have any question about Charizard, let us know at @warbotzchat .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
